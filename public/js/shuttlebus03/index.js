...
const initialize = async () => {
  ...
  map = new google.maps.Map(document.getElementById("map-bus02"), mapOptions);
...
//   const contentDiv = `<div>Mae mung a kuy</div>`;

//   $("#main_kuykuy").html(contentDiv);
// });
...
//   const kuy = "kuy yed hee"
//   const contentDiv = `<div>${kuy}Mae mung a kuy</div>`;

//   $("#map-canvas").html(contentDiv);
